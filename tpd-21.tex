...
Many other systems have been proposed for distributed content dissemination.
Here we consider publish-subscribe decentralized middlewares, federated
applications, and fully peer-to-peer systems.
~\cite{p2p.xmpp,p2p.activitypub,p2p.gossipsub},


- TCP vs UDP (zero/duplicates/not CRDTs - not idempotent - no consensus)
- persistent broadcast TCP with total order
- order of magnitute less efficient
    - throughput
...
Publish-subscribe middlewares (aka \emph{message brokers} assist the
development of decentralized applications by decoupling publishers and
subscribers at the end points.
Examples of \emph{pubsub} systems include \emph{XMPP}, \emph{ActivityPub}, and
\emph{gossipsub}.%
\footnote{
    \url{http://xmpp.org/}\\
    \url{https://www.w3.org/TR/activitypub/}\\
    \url{https://docs.libp2p.io/concepts/publish-subscribe/}
}
...
hypercore
pijul
%LDN: https://link.springer.com/chapter/10.1007/978-3-319-58068-5_33
