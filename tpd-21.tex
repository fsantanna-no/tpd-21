...
%
Consensus is key to eradicate Sybils, which are the major threats to
open forums and decentralized collaborative applications in general: without
consensus, it is not possible, \emph{at the protocol level}, to distinguish
between correct and malicious users.
