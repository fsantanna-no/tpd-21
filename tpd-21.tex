...
A DVCS is relevant because
    (i)   it is a collaborative application, whose
    (ii)  contributions need evaluation from users, and
    (iii) merges require human intervention, which we propose to automate.
