...
with \nreps{30}.
This mechanism dynamically limits the excess of posts in a chain.
With little activity in the chain (e.g, a technical mailing list), it becomes
more and more expensive to continue posting new messages.
However, if the majority of the chain participates at the same time (e.g., a
real-time chat), then the penalty can be reduced to zero.
%
